...
public class UserResource extends ExceptionHandling {
    ...
    public static final String DELETED_SUCCESFULLY = "User Deleted Succesfully";
    ...
    public ResponseEntity<HttpResponse> resetPassword(@PathVariable("emaill") String email) throws EmailNotFoundException, MessagingException {
    ...
    public ResponseEntity<HttpResponse> deleteUser(@PathVariable("id") long id){
        ...
        return response(NO_CONTENT, DELETED_SUCCESFULLY);
    }
    ...
    private ResponseEntity<HttpResponse> response(HttpStatus httpStatus, String s) {
        ...
        return new  ResponseEntity<> (new HttpResponse(httpStatus.value(), httpStatus, httpStatus.getReasonPhrase().toUpperCase(), s.toUpperCase()),httpStatus);
    }
